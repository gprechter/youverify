...
| ------------------------------------------------ | ----- | ------------- |
| Boolean Sort and Operators                       |       | ❌ In Progress |
| Integer Sort and Operators                       |       | ❌ In Progress |
| Bit Vector Sort and Operators                    |       | ❌ In Progress |
| Array Sort and Operators [Including Fixed Sized] |       | ❌ In Progress |
| Labels and Branching Statements                  |       | ❌ In Progress |
| Functions                                        |       | ❌ In Progress |
| Assert Statements                                |       | ❌ In Progress |
